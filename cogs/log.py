...
class Log(Cog):
    ...
    async def on_message_edit(self, before, after):
        ...
        if not after.author.bot and before != message and after != message:
    ...
    async def on_member_update(self, before, after):
        ...
        before_roles = ", ".join([i.mention for i in before.roles if
                                  i.name != '@everyone' or i.name != '­@­━━­━━━━ SKILLS ­━━­━━━━' or i.name != '­@━━━━━ ATTAINMENTS ━━━━­' or i.name != '@­━━━━━   ESTABLISHED  ━━━━­']) or "No roles assigned."
        after_roles = ", ".join([i.mention for i in after.roles if
                                 i.name != '@everyone' or i.name != '­@­━━­━━━━ SKILLS ­━━­━━━━' or i.name != '­@━━━━━ ATTAINMENTS ━━━━­' or i.name != '@­━━━━━   ESTABLISHED  ━━━━­']) or "No roles assigned."
