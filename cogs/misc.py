...
class Misc(commands.Cog):
    ...
    async def whois(self, ctx, user: discord.Member = None):
        ...
        notable_perms = ['administrator', 'manage_guild', 'view_audit_log', 'manage_roles', 'manage_channels', 'ban_members', 'kick_members', 'manage_messages', 'mention_everyone', 'manage_emojis', 'manage_webhooks', 'mute_members', 'deafen_members', 'move_members', 'priority_speaker']
