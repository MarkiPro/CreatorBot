...
class Misc(commands.Cog):
    ...
    async def role(self, ctx, role_name):
        ...
        if re.match("verified", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("devforum member", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("devforum regular", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("devforum top contributor", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("devforum community champion", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("game designer", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("Roblox Studio Builder", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("ui designer", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("gfx designer", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("music composer", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("3d modeler", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("clothing designer", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("youtuber", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("twitch streamer", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("animator", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("translator", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("server booster", ctx.message.content, re.IGNORECASE):
        ...
        if re.match("programmer", ctx.message.content, re.IGNORECASE):
